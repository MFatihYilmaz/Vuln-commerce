...
$token="Tzo0NzoiU3ltZm9ueVxDb21wb25lbnRcQ2FjaGVcQWRhcHRlclxUYWdBd2FyZUFkYXB0ZXIiOjI6
...
$secretKey = "g9retf4snq0abitzwpym3nwt5pcxdtro";
$cookie = urlencode('{"token":"' . $token . '","sig_hmac_sha1":"' . hash_hmac('sha1', $token, $secretKey) . '"}');
echo $cookie;
